...
Future<void> main() async {
  ...
  // Initialize Firebase and any other initial services here
...
class _BybitRegistrationScreenState extends State<BybitRegistrationScreen> {
  ...
  bool _isWebViewVisible = true; // Track WebView visibility
  bool _areOverlaysVisible = true; // Track overlay bars visibility
